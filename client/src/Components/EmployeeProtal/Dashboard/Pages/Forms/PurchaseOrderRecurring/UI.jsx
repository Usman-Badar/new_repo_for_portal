            ...
            <div className="purchase_order">
                {
                    ...
                    ?
                    <BreadCrumb links={[{label: 'All Purchase Orders', href: '/purchase/order/recursive/requests'}]} currentLabel={ "PO Template Details - " + ( RequestDetails ? ( 'Ref #' + RequestDetails.po_id ) : '' ) } />
                    :
                    window.location.hash.includes('/purchase/order/recursive/form')
                    ?
                    <BreadCrumb links={[{label: 'All Purchase Orders', href: '/purchase/order/recursive/requests'}]} currentLabel="Purchase Order Form" />
                    :null
                }
    ...
    return (
        <>
            ...
            <div className="purchase_requests">
                <div className="d-flex align-items-end justify-content-between">
                    <h3 className="heading">
                        Recursive Purchase Orders List
