...
function UI({ AccessControls, onCreateShpCash, Slip, SlipCode, attachSlip, SlipAttachment, SlipList, PRAttachment, PR, PRCode, SPRSpecifications, setPRAttachment, history, Company, Amount, DO, LOLO, Selected, Locations, Employees, PRList, Keyword, Companies, setKeyword, attachPR, setAmount, setDO, setCompany, onCreateAdvanceCash, setEmployee, setSlipAttachment, Status, setStatus, setLOLO, DET, DMGDT, Other, setDET, setDMGDT, setOther }) {
