...
const ShippingLine = ({ Companies, Locations, DO, LOLO, DET, DMGDT, Other, setDET, setDMGDT, setOther, setLOLO, setDO, onCreateShpCash }) => {
    ...
    const total = parseFloat(DO.amount) + parseFloat(LOLO.amount) + parseFloat(DET.amount) + parseFloat(DMGDT.amount) + parseFloat(Other.amount);
    return (
        <>
                    ...
                    <div className="purpose my-4">
                        ...
                        <div className="type">
                            <div className="d-flex">
                                ...
                                <div className='w-100'>
                                    <input type='number' value={Other.amount} onChange={(e) => setOther({...Other, amount: e.target.value})} className="form-control mb-3" id="Other_amount" disabled={!Other.required} />
