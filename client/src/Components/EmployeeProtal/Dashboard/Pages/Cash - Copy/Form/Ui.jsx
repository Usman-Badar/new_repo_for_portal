...
function UI({ Slip, SlipCode, attachSlip, SlipAttachment, SlipList, PRAttachment, PR, PRCode, SPRSpecifications, setPRAttachment, history, Company, Amount, Selected, Locations, Employees, PRList, Keyword, Companies, setKeyword, attachPR, setAmount, setCompany, onCreateAdvanceCash, setEmployee, setSlipAttachment }) {
